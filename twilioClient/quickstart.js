$(function () {
  let speakerDevices = document.getElementById('speaker-devices');
  let ringtoneDevices = document.getElementById('ringtone-devices');
  ...
  document.getElementById("button-call").onclick = function() {
    ...
    if (device) {
      let outgoingConnection = device.connect(params);
